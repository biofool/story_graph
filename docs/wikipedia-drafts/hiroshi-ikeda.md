...
- **Aikido Bridge addition** — proposed sentence (2005 founding, "Un
  ...
  judge acceptability.
- **Hawaii seminars NOT citable** — Floating Bridge / Ka'u Aikikai
  (Big Island, 2024–2026 + Jan 2027 planned) is sourced only to Bob
  Klein's personal email. Becomes citable if the dojo publishes
  announcements or the 2024/2025 flyers surface (Gary Reiss outreach
  pending — `greissoffice@gmail.com`).
...
- **0 RELIABLE sources** in the Ikeda subgraph — every Ikeda source is
  his own site, a Google-sheets calendar, or personal communication.
  Nothing new can be cited independently today.
...
- **GNG**: the article exists; notability itself isn't the issue —
  **citable new material is**. Compare report: 452 candidate additions,
  **0 citable uncited sources**; nearly all are routine seminar
  listings or non-citable classes of evidence.
- **Compare verdict**: live article is reasonably complete for what
  independent sources cover; the graph's research frontier (Hawaii,
  Aikido Bridge detail, visited-dojos list) is mostly personal
